        ...
        <div className="grid gap-12 lg:grid-cols-3">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="nb-card flex items-center gap-3 bg-card p-3">
                  <div className="size-12 animate-pulse rounded-full border-[2.5px] border-[var(--nb-shadow)] bg-muted nb-shadow-sm" />
                  <div className="space-y-2">
                    <div className="h-3 w-20 animate-pulse rounded border-[2px] border-[var(--nb-shadow)] bg-muted nb-shadow-sm" />
                    <div className="h-3 w-16 animate-pulse rounded border-[2px] border-[var(--nb-shadow)] bg-muted nb-shadow-sm" />
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="h-4 w-full animate-pulse rounded-lg border-[2px] border-[var(--nb-shadow)] bg-muted nb-shadow-sm" />
              <div className="h-4 w-full animate-pulse rounded-lg border-[2px] border-[var(--nb-shadow)] bg-muted nb-shadow-sm" />
              <div className="h-4 w-2/3 animate-pulse rounded-lg border-[2px] border-[var(--nb-shadow)] bg-muted nb-shadow-sm" />
            </div>
          </div>
        </div>
      </div>
